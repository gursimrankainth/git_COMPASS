...
// *************************  X-CHECK 1 RHO0 *************************** 
bool crossCheck(const PaEvent &e, const PaVertex & v,int iv, int Run,const BeamFluxParams &params, PaParticle &beam, 
				PaTrack &beam_track, PaTPar &Par_beam, PaHodoHelper* HodoHelper, const OutMuParams &outparams, 
				PaParticle &outMu, PaTrack &outMu_track,  PaTPar &Par_outMu,EventFlags &flags) {
...
// *************************  X-CHECK 2 RHO0 *************************** 
bool crossCheck2(const PaEvent &e, const PaVertex & v,int iv, int Run,const BeamFluxParams &params, PaParticle &beam, 
				PaTrack &beam_track, PaTPar &Par_beam, PaHodoHelper* HodoHelper, const OutMuParams &outparams, 
	...
	if (outMu_track.Chi2tot()/outMu_track.Ndf() > 10) {
                 return false;
    } else {flags.setFlagByName("muChi2_flag", true);} 
